...
\begin{itemize}
    \itembf{Number of parties.} Two-party computation is an important special case $m=2$ which has a large dedicated body of research as it achieves own specific feasibility results due to nature of the problem, i.e., there is no honest majority and often motivated by popular client-server paradigm. Separate group constitutes also 3-party computation, \emph{3PC} \cite{CKMZ14, MRZ15}.
